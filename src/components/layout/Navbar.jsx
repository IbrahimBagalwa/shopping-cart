    ...
    <nav className="sticky top-0 z-50 bg-white">
      <PageWrapper>
        <div className="flex flex-col items-center justify-center sm:flex-row sm:items-center sm:justify-between">
          <Link to="/">
            <h1 className="relative text-[#F04444] font-extrabold text-2xl py-4 pr-0 pl-2 before:content-[''] before:absolute before:left-[40%] before:bottom-4 before:-z-10 before:w-25 before:h-2.5 before:bg-indigo-300/50 before:transform before:-skew-x-12 before:-translate-x-1/2">
              Shopping Cart
            </h1>
          </Link>
            ...
            >
              ...
              <div>
                ...
                <p className="text-gray-500">
                  {numberOfItemsInInCart}{" "}
                  {numberOfItemsInInCart <= 1 ? "item" : "items"}
                </p>
              </div>
            </div>
          </Link>
